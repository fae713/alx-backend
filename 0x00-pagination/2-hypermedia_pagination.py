#!/usr/bin/env python3
"""
This is the Hypermedia pagination task.
"""
...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        This method takes two integer arguments page with
        ...
        assert isinstance(page_size, int) and page_size > 0, "page must be +ve"
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict:
        """
        A method that returns a dictionary containing the following a dict
        Args:
            page (int): The current page number, 1-indexed. Defaults to 1.
            page_size (int): The number of items per page. Defaults to 10.
